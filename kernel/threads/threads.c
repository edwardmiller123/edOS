...
// new threads stack. We then return to the irq stub which calls an assembly routine to
// actually switch the satck pointer if we are in ring 0. If we are in ring 3 then the stack 
